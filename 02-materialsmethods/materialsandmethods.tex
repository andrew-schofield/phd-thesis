...
Nitrite concentration in liquid culture was determined using the colorimetric assay described by \citet{DonaldNicholas1957}. This reaction is based on chemical diazotization which uses sulfanilamide and NED\nomenclature{NED}{\textit{N}-1-napthylethylenediamine dihydrochloride} under acidic (hydrochloric acid) conditions.
