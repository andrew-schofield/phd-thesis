...
\begin{figure}[p]
 ...
 \caption[Posterior probability distributions for oxygen reduction]{{\bf Posterior probability distributions for oxygen reduction}. These are the probability distributions generated by parameter estimation on 3 oxygen reduction datasets. These have been overlaid onto the prior probability distributions used by the parameter estimation algorithm, also shown in Figure \ref{fig:oxypriors}. The various posterior distributions displayed here are all marginal distributions of a single joint distribution. This applies to all subsequent probability distributions.
