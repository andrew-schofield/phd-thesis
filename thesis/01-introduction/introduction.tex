...
\begin{figure}[tbp]
	...
	\caption{{\bf Structure of the ubiquinone molecule.}
...
\begin{figure}
\begin{center}
	\includegraphics[width=14cm]{01-introduction/data/paracoccus.png}
	\caption{{\bf Branched electron transport chains of \textit{Paracoccus} species.} Enzyme complexes colored black indicate a periplasmic location. Electron transfer between cytochromes $c_{552}$ and $c_{550}$ has not been demonstrated experimentally but is possible, given the redox potential of the proteins. The exact nature of the roles of cytochrome $c_{550}$ and pseudoazurin is currently being studied. UQ = ubiquinone, UQH2 = reduced ubiquinone. TOMES, thiosulfate oxidation multienzyme system.Adapated from \citet{Baker1998}} 
	\label{fig:paracoccus}}
\end{center}
\end{figure}
