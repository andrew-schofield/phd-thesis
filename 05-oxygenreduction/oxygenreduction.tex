...
\begin{figure}[tbp]
 \centering
 %trim = l b r t
 \includegraphics[width=14cm, trim=125px 100px 150px 100px]{./05-oxygenreduction/data/mc58-chl-o2-util.pdf}
...
\begin{figure}[tbp]
 \centering
 \includegraphics[width=14cm]{./05-oxygenreduction/data/repeatable-oxygen-utilisation-in-mc58.png}
