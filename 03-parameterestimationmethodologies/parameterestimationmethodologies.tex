...
\begin{figure}[t]
 \centering
 \includegraphics[width=13cm, trim=75px 53px 125px 30px, clip=true]{./03-parameterestimationmethodologies/data/LV_data.pdf}
...
\begin{figure}[b]
 \centering
 \includegraphics[width=13cm, trim=75px 53px 125px 30px, clip=true]{./03-parameterestimationmethodologies/data/LV_MCMC.pdf}
 % Simulation.png: 800x600 pixel, 72dpi, 28.22x21.17 cm, bb=0 0 800 600
