...
\subsection{Cytochrome $\mathrm{bc}_\mathrm{1}$ Complex}
\subsection{Cytochromes $\mathrm{c}_\mathrm{4}$, $\mathrm{c}_\mathrm{x}$ and $\mathrm{c}_\mathrm{5}$}
...
\subsection{Aims}
The layout of \Nm{} respiratory chain, even though longer than that of the model organism \textit{Escherichia coli} is more similar to other bacteria. This, along with its profound medical important make it an excellent target for mathematical modelling.
