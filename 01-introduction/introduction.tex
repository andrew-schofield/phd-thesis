...
\begin{center}
	...
	\label{fig:nm_resp}}
\end{center}
\end{figure}The components are coloured consistently throughout this section to allow easy comparison between the respiratory chains being discussed. As discussed previously, the respiratory chain of \Nm{} contains an initial electron donor, in this case NADH dehydrogenase. This actually represents all the possible electron donors. NADH is considered to be the main electron donor along with succinate\cite{Baart2007}. There is also a quinone pool, consisting of ubiquinone/ubiquinol, intermediate \textit{c}-type cytochromes and terminal reductases. The following section introduces the electron transport chains of a number of other bacteria as they are well studied model organisms for comparison with \Nm{}.
